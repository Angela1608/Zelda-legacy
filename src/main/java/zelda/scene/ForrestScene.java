...
public class ForrestScene extends ZeldaScene {
    ...
    private void initializeSolids() {
        solids.add(drawFirstUpperTreeline());
        solids.add(drawFirstLeftTreeline());
        solids.add(drawSecondUpperTreeline());
        solids.add(drawSecondLeftTreeline());
        solids.add(drawMiddleTreeline());
        solids.add(drawFirstEntreeWall());
        solids.add(drawSecondEntreeWall());
        solids.add(drawLowerWall());
        solids.add(drawFirstDeadTree());
        solids.add(drawSecondDeadTree());
        solids.add(drawThirdDeadTree());
    }
    ...
    private void initializePolygons() {
        drawFirstUpperTreeline();
        drawSecondUpperTreeline();
        drawFirstLeftTreeline();
        drawSecondLeftTreeline();
        drawMiddleTreeline();
        drawFirstEntreeWall();
        drawSecondEntreeWall();
        drawLowerWall();
        drawFirstDeadTree();
        drawSecondDeadTree();
        drawThirdDeadTree();
    ...
    private Polygon drawFirstUpperTreeline() {
    ...
    private Polygon drawSecondUpperTreeline() {
    ...
    private Polygon drawFirstLeftTreeline() {
    ...
    private Polygon drawSecondLeftTreeline() {
    ...
    private Polygon drawMiddleTreeline() {
    ...
    private Polygon drawFirstEntreeWall() {
    ...
    private Polygon drawSecondEntreeWall() {
