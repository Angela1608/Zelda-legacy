...
public class HyruleScene extends ZeldaScene {
    ...
    private static final String IMAGE_HYRULE = "images/hyrule.png";
    private static final String SOUND_OVERWORLD = "sounds/overworld.mp3";
    ...
    public HyruleScene(Game game, String entrance) {
        super(game, IMAGE_HYRULE, "HyruleScene");
        exits.add(exitDown);
        exits.add(hatch);
        exits.add(stairs);
        exits.add(door);
    ...
    private void initializePolygons() {
        createFirstTree();
        createSecondTree();
        createSecondCastleWall();
        createThirdCastleWall();
        createFirstCastleWall();
        createWall();
        createDownWall();
        createSecondDownWall();
        createFirstBush();
        createSecondBush();
        createThirdBush();
        createBalk();
    ...
    private void initializeSolids() {
        solids.add(createBalk());
        solids.add(createGarden());
        solids.add(createSecondGarden());
        solids.add(createThirdGarden());
        solids.add(createFirstBush());
        solids.add(createSecondBush());
        solids.add(createThirdBush());
        solids.add(createFirstTree());
        solids.add(createSecondTree());
        solids.add(createFirstCastleWall());
        solids.add(createSecondCastleWall());
        solids.add(createThirdCastleWall());
        solids.add(createWall());
        solids.add(createSecondWall());
        solids.add(createDownWall());
        solids.add(createSecondDownWall());
    }
    ...
    private void handleMusic(Game game) {
        if (!game.getSong().equals(SOUND_OVERWORLD)) {
            game.stopMusic();
            game.playMusic(SOUND_OVERWORLD, true);
        }
    }

    private Polygon createFirstTree() {
    ...
    private Polygon createSecondTree() {
    ...
    private Polygon createSecondCastleWall() {
        int[] cxpos = {40, 42, 465, 464, 457, 464, 476, 473, 462, 462, 272, 272, 284, 285, 270, 272, 336, 338, 361,
                363, 389, 390, 426, 426, 450, 454, 472, 473, 485, 485, 451, 369, 366, 241, 241, 34};
        int[] cypos = {904, 889, 887, 713, 713, 628, 627, 567, 567, 545, 541, 461, 461, 338, 334, 166, 166, 243, 245,
                258, 257, 240, 240, 260, 259, 240, 238, 270, 270, 164, 161, 160, 115, 114, 358, 898};
    ...
    private Polygon createThirdCastleWall() {
        int[] fxpos = {561, 562, 750, 752, 738, 739, 752, 751, 736, 735, 705, 704, 688, 687, 687, 702, 704, 672, 672,
                664, 662, 634, 633, 633, 597, 597, 599, 599, 578, 577, 577, 570, 570, 552, 552, 538, 538, 576, 575,
                656, 657, 781, 784, 768, 768, 782, 781, 593};
        int[] fypos = {562, 545, 543, 465, 463, 337, 336, 168, 168, 187, 187, 169, 167, 240, 246, 247, 260, 261, 243,
                243, 257, 257, 247, 240, 239, 256, 265, 368, 368, 266, 259, 259, 242, 242, 276, 277, 163, 161, 193,
                191, 113, 114, 355, 358, 414, 417, 563, 564};
    ...
    private Polygon createFirstCastleWall() {
    ...
    private Polygon createWall() {
        int[] gxpos = {848, 870, 872, 878, 887, 883, 891, 888, 898, 908, 918, 930, 934, 932, 933, 939, 937, 945,
                951, 953, 937, 937, 905, 905, 920, 919, 906, 905, 919, 921, 938, 1015, 1014, 975, 974, 938, 892,
                561, 560, 829, 837, 835, 841, 841, 855, 861, 870, 885, 885, 892, 889, 895, 908, 956, 961, 992,
                990, 919, 576, 577, 908, 961, 1011, 1013, 961, 962, 990, 992, 965, 888, 877, 849};
        int[] gypos = {53, 55, 47, 47, 73, 75, 82, 91, 91, 98, 92, 95, 91, 86, 80, 77, 73, 50, 50, 183, 185, 199,
                200, 212, 212, 295, 297, 310, 310, 615, 630, 629, 672, 675, 667, 667, 713, 712, 883, 886, 900, 908,
                913, 922, 922, 935, 924, 926, 916, 910, 904, 887, 886, 935, 988, 988, 921, 850, 846, 776, 772, 727,
                724, 593, 570, 245, 210, 42, 15, 15, 9, 9};
    ...
    private Polygon createSecondBush() {
    ...
    private Polygon createThirdBush() {
    ...
    private Polygon createSecondGarden() {
    ...
    private Polygon createThirdGarden() {
