...
public class CastleBasementScene extends ZeldaScene {
    ...
    private static final String SOUND_CASTLE = "sounds/castle.mp3";
    private static final String IMAGE_CASTLEBASEMENT = "images/castlebasement.png";
    ...
    public CastleBasementScene(Game game, String entrance) {
        super(game, IMAGE_CASTLEBASEMENT, "CastleBasementScene");
        initializeExists();
    ...
    private Polygon createFirstWall() {
        ...
        return new Polygon(wxpos1, wypos1, wypos1.length);
    }
    ...
    private Polygon createSecondWall() {
        ...
        return new Polygon(wxpos2, wypos2, wypos2.length);
    }

    private Polygon createThirdWall() {
        int[] wxpos3 = {854, 783, 783, 825, 825, 788, 787, 823, 823, 776, 775, 737, 736, 777, 776, 783, 783, 706,
                706, 799, 799, 792, 791, 799, 799, 763, 764, 868, 868, 909};
        int[] wypos3 = {38, 57, 77, 78, 215, 218, 311, 312, 333, 334, 341, 341, 372, 369, 399, 400, 468, 471, 573,
                576, 622, 623, 655, 656, 701, 703, 778, 775, 930, 926};
        return new Polygon(wxpos3, wypos3, wypos3.length);
    }

    private Polygon createFourthWall() {
        int[] wxpos4 = {868, 399, 399, 179, 177, 98, 98};
        int[] wypos4 = {930, 934, 808, 801, 790, 790, 934};
        return new Polygon(wxpos4, wypos4, wypos4.length);
    }

    private Polygon createFifthWall() {
        int[] wxpos5 = {437, 264, 264, 248, 248, 153,};
        int[] wypos5 = {678, 678, 748, 748, 680, 678,};
        return new Polygon(wxpos5, wypos5, wypos5.length);
    }

    private Polygon createSixthWall() {
        int[] wxpos6 = {97, 97, 73, 73, 114, 111, 145, 33};
        int[] wypos6 = {789, 439, 439, 375, 375, 119, 113, 113};
        return new Polygon(wxpos6, wypos6, wypos6.length);
    }

    private Polygon createSeventhWall() {
        int[] wxpos7 = {447, 447, 432, 432, 417, 417, 352, 352, 337, 337, 323, 323, 187, 192, 145, 145, 189, 189,
                148, 148, 148, 189, 447};
        int[] wypos7 = {421, 368, 368, 359, 359, 336, 338, 358, 358, 365, 365, 377, 377, 366, 366, 155, 155, 80, 80,
                112, 80, 80, 30};
        return new Polygon(wxpos7, wypos7, wypos7.length);
    }

    private Polygon createFirstBlock() {
    ...
    private Polygon createSecondBlock() {
        int[] bxpos2 = {216, 201, 201, 216};
        int[] bypos2 = {757, 757, 687, 687};
        return new Polygon(bxpos2, bypos2, bypos2.length);
    }

    private Polygon createThirdBlock() {
        int[] bxpos3 = {166, 154, 154, 166};
        int[] bypos3 = {780, 780, 737, 737};
        return new Polygon(bxpos3, bypos3, bypos3.length);
    }

    private void initializeSolids() {
        solids.add(createFirstWall());
        solids.add(createSecondWall());
        solids.add(createThirdWall());
        solids.add(createFourthWall());
        solids.add(createFifthWall());
        solids.add(createSixthWall());
        solids.add(createSeventhWall());
        solids.add(createFirstBlock());
        solids.add(createSecondBlock());
        solids.add(createThirdBlock());
    }
